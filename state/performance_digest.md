...
Content Types → Thread: 0.40% (n=51)
Best Hook by platform → Threads=A (n=6, 0.82%) vs B (n=19, 0.71%) = 1.16x, X=B (n=1, 1.62%) vs A (n=13, 0.74%) = 2.20x
X link A/B (engagement) → n/a
Threads link A/B (engagement) → no_link: 0.80% (n=8); link: 0.67% (n=13)
Followers (7d) → X -1, Threads +74, Instagram +1
```
...
Content runway
  Instagram (carousel drip) : 5 days
  X / Threads (post loop)   : 4 days (4 Notion drafts + 0 awaiting insert)
